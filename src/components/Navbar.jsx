        ...
        <>
            <div className="container d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <nav className="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    <NavLink className="me-3 py-2 text-dark text-decoration-none" to="/game">Game</NavLink>
                    <NavLink className="me-3 py-2 text-dark text-decoration-none" to="/posts">Posts</NavLink>
